...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_14028 = 0;while(true){
if((i_14028 < arr.length))
{(arr[i_14028] = null);
{
var G__14029 = (i_14028 + 1);
i_14028 = G__14029;
continue;
}
} else
...
{var i_14035 = (self__.level + 1);while(true){
if((i_14035 <= (new_level + 1)))
{(update[i_14035] = self__.header);
{
var G__14036 = (i_14035 + 1);
i_14035 = G__14036;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_14037 = 0;while(true){
if((i_14037 <= self__.level))
{var links_14038 = (update[i_14037]).forward;if(((links_14038[i_14037]) === x__$1))
{(links_14038[i_14037] = (x__$1.forward[i_14037]));
{
var G__14039 = (i_14037 + 1);
i_14037 = G__14039;
continue;
}
} else
{{
var G__14040 = (i_14037 + 1);
i_14037 = G__14040;
continue;
}
}
