...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_14063 = 0;while(true){
var m_14064 = cljs.core.async.impl.dispatch.tasks.pop();if((m_14064 == null))
{} else
{m_14064.call(null);
if((count_14063 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__14065 = (count_14063 + 1);
count_14063 = G__14065;
continue;
}
} else
{}
