...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t14069 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t14069 = (function (val,box,meta14070){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t14069.cljs$lang$type = true;
cljs.core.async.impl.channels.t14069.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t14069";
cljs.core.async.impl.channels.t14069.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"cljs.core.async.impl.channels/t14069");
});
cljs.core.async.impl.channels.t14069.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t14069.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_14071){var self__ = this;
var _14071__$1 = this;return self__.meta14070;
});
cljs.core.async.impl.channels.t14069.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_14071,meta14070__$1){var self__ = this;
var _14071__$1 = this;return (new cljs.core.async.impl.channels.t14069(self__.val,self__.box,meta14070__$1));
});
cljs.core.async.impl.channels.__GT_t14069 = (function __GT_t14069(val__$1,box__$1,meta14070){return (new cljs.core.async.impl.channels.t14069(val__$1,box__$1,meta14070));
});
}
return (new cljs.core.async.impl.channels.t14069(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_14072 = self__.takes.pop();if((taker_14072 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_14072))
{var take_cb_14073 = cljs.core.async.impl.protocols.commit.call(null,taker_14072);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_14073,taker_14072){
return (function (){return take_cb_14073.call(null,null);
});})(take_cb_14073,taker_14072))
);
} else
{}
{
