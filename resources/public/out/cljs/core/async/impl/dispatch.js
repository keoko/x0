...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_47415 = 0;while(true){
var m_47416 = cljs.core.async.impl.dispatch.tasks.pop();if((m_47416 == null))
{} else
{m_47416.call(null);
if((count_47415 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__47417 = (count_47415 + 1);
count_47415 = G__47417;
continue;
}
} else
{}
