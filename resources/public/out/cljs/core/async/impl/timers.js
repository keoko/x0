...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_47380 = 0;while(true){
if((i_47380 < arr.length))
{(arr[i_47380] = null);
{
var G__47381 = (i_47380 + 1);
i_47380 = G__47381;
continue;
}
} else
...
{var i_47387 = (self__.level + 1);while(true){
if((i_47387 <= (new_level + 1)))
{(update[i_47387] = self__.header);
{
var G__47388 = (i_47387 + 1);
i_47387 = G__47388;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_47389 = 0;while(true){
if((i_47389 <= self__.level))
{var links_47390 = (update[i_47389]).forward;if(((links_47390[i_47389]) === x__$1))
{(links_47390[i_47389] = (x__$1.forward[i_47389]));
{
var G__47391 = (i_47389 + 1);
i_47389 = G__47391;
continue;
}
} else
{{
var G__47392 = (i_47389 + 1);
i_47389 = G__47392;
continue;
}
}
