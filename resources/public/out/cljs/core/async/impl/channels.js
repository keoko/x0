...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t47421 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t47421 = (function (val,box,meta47422){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t47421.cljs$lang$type = true;
cljs.core.async.impl.channels.t47421.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t47421";
cljs.core.async.impl.channels.t47421.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"cljs.core.async.impl.channels/t47421");
});
cljs.core.async.impl.channels.t47421.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t47421.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_47423){var self__ = this;
var _47423__$1 = this;return self__.meta47422;
});
cljs.core.async.impl.channels.t47421.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_47423,meta47422__$1){var self__ = this;
var _47423__$1 = this;return (new cljs.core.async.impl.channels.t47421(self__.val,self__.box,meta47422__$1));
});
cljs.core.async.impl.channels.__GT_t47421 = (function __GT_t47421(val__$1,box__$1,meta47422){return (new cljs.core.async.impl.channels.t47421(val__$1,box__$1,meta47422));
});
}
return (new cljs.core.async.impl.channels.t47421(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_47424 = self__.takes.pop();if((taker_47424 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_47424))
{var take_cb_47425 = cljs.core.async.impl.protocols.commit.call(null,taker_47424);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_47425,taker_47424){
return (function (){return take_cb_47425.call(null,null);
});})(take_cb_47425,taker_47424))
);
} else
{}
{
