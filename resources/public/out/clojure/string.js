...
{{
var G__43534 = cljs.core.pop.call(null,v__$1);
v__$1 = G__43534;
continue;
}
} else
...
{var pred__43538 = cljs.core._EQ_;var expr__43539 = limit;if(cljs.core.truth_(pred__43538.call(null,1,expr__43539)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__43538.call(null,2,expr__43539)))
...
var G__43541 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__43542 = (limit__$1 - 1);
var G__43543 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__43541;
limit__$1 = G__43542;
parts = G__43543;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___43545 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___43545))
{var replacement_43546 = temp__4090__auto___43545;buffer.append([cljs.core.str(replacement_43546)].join(''));
} else
{buffer.append(ch);
}
{
