...
sablono.util.ToString = (function (){var obj43483 = {};return obj43483;
})();
...
sablono.util.ToURI = (function (){var obj43485 = {};return obj43485;
})();
...
as_str.cljs$lang$applyTo = (function (arglist__43486){
var xs = cljs.core.seq(arglist__43486);
...
{var vec__43488 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);var first_word = cljs.core.nth.call(null,vec__43488,0,null);var words = cljs.core.nthnext.call(null,vec__43488,1);if((cljs.core.empty_QMARK_.call(null,words)) || (cljs.core._EQ_.call(null,"aria",first_word)) || (cljs.core._EQ_.call(null,"data",first_word)))
{return k;
} else
...
var merge_with_class__delegate = function (maps){var classes = cljs.core.vec.call(null,cljs.core.remove.call(null,cljs.core.nil_QMARK_,cljs.core.mapcat.call(null,(function (p1__43489_SHARP_){if(cljs.core.list_QMARK_.call(null,p1__43489_SHARP_))
{return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [p1__43489_SHARP_], null);
} else
{if(cljs.core.sequential_QMARK_.call(null,p1__43489_SHARP_))
{return p1__43489_SHARP_;
} else
...
merge_with_class.cljs$lang$applyTo = (function (arglist__43490){
...
{}
var vec__43499 = sablono.util.match_tag.call(null,tag);var tag__$1 = cljs.core.nth.call(null,vec__43499,0,null);var id = cljs.core.nth.call(null,vec__43499,1,null);var class$ = cljs.core.nth.call(null,vec__43499,2,null);var tag_attrs = sablono.util.compact_map.call(null,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"id","id",1013907597),id,new cljs.core.Keyword(null,"class","class",1108647146),class$], null));var map_attrs = cljs.core.first.call(null,content);if(cljs.core.map_QMARK_.call(null,map_attrs))
